...
function hospital_management_customize_register($wp_customize){
    ...
    $wp_customize->add_setting( 'hospital_management_blog_post_columns', array(
        'default'  => 'Two',
        'sanitize_callback' => 'hospital_management_sanitize_choices'
    ));
    $wp_customize->add_control( 'hospital_management_blog_post_columns', array(
        'section' => 'hospital_management_post_settings',
        'type' => 'select',
        'label' => __( 'No. of Posts per row', 'hospital-management' ),
        'choices' => array(
            'One'  => __( 'One', 'hospital-management' ),
            'Two' => __( 'Two', 'hospital-management' ),
            'Three' => __( 'Three', 'hospital-management' ),
        )
    ));
    ...
    $wp_customize->add_setting( 'hospital_management_blog_sidebar_position', array(
        'default'           => 'Right Side',
        'sanitize_callback' => 'hospital_management_sanitize_choices'
    ));
    $wp_customize->add_control( 'hospital_management_blog_sidebar_position', array(
        'section' => 'hospital_management_post_settings',
        'type' => 'select',
        'label' => __( 'Post Page Sidebar Position', 'hospital-management' ),
        'choices' => array(
            'Right Side' => __( 'Right Side', 'hospital-management' ),
            'Left Side' => __( 'Left Side', 'hospital-management' ),
        )
    ));
    ...
    $wp_customize->add_setting('hospital_management_single_post_page_tag',array(
        'sanitize_callback' => 'hospital_management_sanitize_checkbox',
        'default'           => 1,
    ));
    $wp_customize->add_control('hospital_management_single_post_page_tag',array(
        'type'  => 'checkbox',
        'label' => esc_html__('Enable Single Post Page Tag', 'hospital-management'),
        'section' => 'hospital_management_post_settings',
        'description' => esc_html__('Check this box to enable content on single post page.', 'hospital-management'),
    ));

    $wp_customize->add_setting( 'hospital_management_single_post_sidebar_position', array(
        'default'           => 'Right Side',
        'sanitize_callback' => 'hospital_management_sanitize_choices'
    ));
    $wp_customize->add_control( 'hospital_management_single_post_sidebar_position', array(
        'section' => 'hospital_management_post_settings',
        'type' => 'select',
        'label' => __( 'Single Post Sidebar Position', 'hospital-management' ),
        'choices' => array(
            'Right Side' => __( 'Right Side', 'hospital-management' ),
            'Left Side' => __( 'Left Side', 'hospital-management' ),
        )
    ...
    // Page Settings
    $wp_customize->add_section('hospital_management_page_settings',array(
        'title' => esc_html__('Page Settings','hospital-management'),
        'priority' => 40,
    ));

    $wp_customize->add_setting( 'hospital_management_single_page_sidebar_layout', array(
        'default'           => 'No Sidebar',
        'sanitize_callback' => 'hospital_management_sanitize_choices'
    ));
    $wp_customize->add_control( 'hospital_management_single_page_sidebar_layout', array(
        'section' => 'hospital_management_page_settings',
        'type' => 'select',
        'label' => __( 'Single Page Sidebar Position', 'hospital-management' ),
        'choices' => array(
            'No Sidebar' => __( 'No Sidebar', 'hospital-management' ),
            'Right Side' => __( 'Right Side', 'hospital-management' ),
            'Left Side' => __( 'Left Side', 'hospital-management' ),
        )
    ));
