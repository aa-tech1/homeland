	...
	function WidgetManager(demo_type) {
        ...
        if(demo_type == 'builder'){
    		...
    		function import_widgets(){
                jQuery.post(
    				business_development_coaching_whizzie_params.ajaxurl,
    				{
    					wpnonce: business_development_coaching_whizzie_params.wpnonce
...
jQuery(document).ready(function(){
    ...
    if(current_menu == 1){
        ...
        jQuery('#toplevel_page_businessdevelopmentcoaching-wizard').addClass('current');
    }
