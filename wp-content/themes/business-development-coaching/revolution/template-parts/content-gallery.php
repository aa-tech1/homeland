...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="card-item card-blog-post">
		<?php
		    ...
		    $business_development_coaching_gallery_shortcode = get_post_gallery();

			if (!is_singular() && !empty($business_development_coaching_gallery_shortcode)) {
				if (!empty($business_development_coaching_gallery_shortcode)) {
					// Display the gallery
					echo '<div class="embedded-gallery">' . do_shortcode($business_development_coaching_gallery_shortcode) . '</div>';
				}
			}
		?>
