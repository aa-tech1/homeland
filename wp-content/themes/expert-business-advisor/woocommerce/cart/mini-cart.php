...
<?php if ( ! WC()->cart->is_empty() ) : ?>
			...
			<?php 
				if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
					...
					<?php 
						...
						?>
						<span class="badge"><?php echo esc_html('0','expert-business-advisor'); ?></span>
						<?php 
					}
				}
			?>
		</div>
		<h3><?php _e( 'Total:', 'expert-business-advisor' ); ?> <?php echo WC()->cart->get_cart_subtotal(); ?></h3>
	</div>
				...
				<li class="woocommerce-mini-cart-item <?php echo esc_attr( apply_filters( 'woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key ) ); ?>">
					...
					echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
						...
						sprintf(
							...
							esc_attr__( 'Remove this item', 'expert-business-advisor' ),
							esc_attr( $product_id ),
	...
	<a href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="theme-button"><?php echo esc_html_e('Checkout','expert-business-advisor'); ?> </a>

	<?php do_action( 'woocommerce_widget_shopping_cart_after_buttons' ); ?>

<?php else : ?>

	<p class="woocommerce-mini-cart__empty-message"><?php esc_html_e( 'No products in the cart.', 'expert-business-advisor' ); ?></p>
...
<li class="shopping-cart">
	<?php if ( ! WC()->cart->is_empty() ) : ?>
		...
		<a href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="theme-button"><?php echo esc_html('Checkout','expert-business-advisor'); ?> </a>
