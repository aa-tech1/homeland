( function( $ ) {
  var this_obj = expert_business_advisor_customizer_params;
  ...
  api.bind( 'pane-contents-reflowed', function() {
    ...
    api.section.each( function( section ) {
      ...
      if (
        'expert_business_advisor_section' !== section.params.type ||
    ...
    api.panel.each( function( panel ) {
      ...
      if (
        'expert_business_advisor_panel' !== panel.params.type ||
  ...
  wp.customize.Panel = wp.customize.Panel.extend({
    attachEvents: function() {
      ...
      if (
        'expert_business_advisor_panel' !== this.params.type ||
  ...
  wp.customize.Section = wp.customize.Section.extend({
    attachEvents: function() {
      if (
        'expert_business_advisor_section' !== this.params.type ||
...
(function (api) {
  ...
  api.Tab = api.Control.extend({
    ready: function () {
      var control = this;
      control.container.find('a.expert-business-advisor-customizer-tab').click(function (evt) {
        var tab = jQuery(this).data('tab');
        evt.preventDefault();
        control.container.find('a.expert-business-advisor-customizer-tab').removeClass('active');
  ...
  jQuery.extend(api.controlConstructor, {
    'expert-business-advisor-tab': api.Tab
  });
