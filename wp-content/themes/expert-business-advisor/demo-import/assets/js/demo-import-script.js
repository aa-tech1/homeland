...
jQuery(document).ready(function(){
    ...
    jQuery('#expert-business-advisor-demo-setup-guid .expert-business-advisor-setup-menu').attr("checked","checked");

    jQuery('#expert-business-advisor-setup-menu').click(function(){
        jQuery('#expert-business-advisor-demo-setup-guid .expert-business-advisor-setup-menu').css("display","block");
        jQuery('#expert-business-advisor-demo-setup-guid .expert-business-advisor-setup-contact').css("display","none");
        jQuery('#expert-business-advisor-demo-setup-guid .expert-business-advisor-setup-widget').css("display","none");
        jQuery('#expert-business-advisor-demo-setup-guid .expert-business-advisor-setup-social-icon').css("display","none");
    });

    jQuery('#expert-business-advisor-setup-contact').click(function(){
        jQuery('#expert-business-advisor-demo-setup-guid .expert-business-advisor-setup-menu').css("display","none");
        jQuery('#expert-business-advisor-demo-setup-guid .expert-business-advisor-setup-contact').css("display","block");
        jQuery('#expert-business-advisor-demo-setup-guid .expert-business-advisor-setup-widget').css("display","none");
        jQuery('#expert-business-advisor-demo-setup-guid .expert-business-advisor-setup-social-icon').css("display","none");
    });

    jQuery('#expert-business-advisor-setup-widget').click(function(){
        jQuery('#expert-business-advisor-demo-setup-guid .expert-business-advisor-setup-menu').css("display","none");
        jQuery('#expert-business-advisor-demo-setup-guid .expert-business-advisor-setup-contact').css("display","none");
        jQuery('#expert-business-advisor-demo-setup-guid .expert-business-advisor-setup-widget').css("display","block");
        jQuery('#expert-business-advisor-demo-setup-guid .expert-business-advisor-setup-social-icon').css("display","none");
    });

    jQuery('#expert-business-advisor-setup-social').click(function(){
        jQuery('#expert-business-advisor-demo-setup-guid .expert-business-advisor-setup-menu').css("display","none");
        jQuery('#expert-business-advisor-demo-setup-guid .expert-business-advisor-setup-contact').css("display","none");
        jQuery('#expert-business-advisor-demo-setup-guid .expert-business-advisor-setup-widget').css("display","none");
        jQuery('#expert-business-advisor-demo-setup-guid .expert-business-advisor-setup-social-icon').css("display","block");
    });
});