...
if ( ! class_exists( 'Expert_Business_Advisor_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Expert_Business_Advisor_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Expert_Business_Advisor_WPTT_WebFont_Loader( $url );
